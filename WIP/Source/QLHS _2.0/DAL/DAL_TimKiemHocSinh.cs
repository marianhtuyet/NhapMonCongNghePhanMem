    ...
    public class DAL_TimKiemHocSinh : DBConnect
    {
        public DataTable TimKiemHocSinh(DTO_TimKiemHocSinh tk)
        {
            ...
            if (tk.TenCot == "NGAYSINH")
            {
                ...
                SqlDataAdapter da2 = new SqlDataAdapter("SELECT * FROM HSHS WHERE day(NGAYSINH) = " + a + "", _conn);
                DataTable dtTimKiemHocSinh = new DataTable();
            ...
            {
                int a = Convert.ToInt32(tk.TenTimKiem);
                SqlDataAdapter da2 = new SqlDataAdapter("SELECT * FROM HSHS WHERE month(NGAYSINH) = " + a + "", _conn);
                DataTable dtTimKiemHocSinh = new DataTable();
                da2.Fill(dtTimKiemHocSinh);
                da2.Dispose();
                return dtTimKiemHocSinh;
            ...
            {
                int a = Convert.ToInt32(tk.TenTimKiem);
                SqlDataAdapter da2 = new SqlDataAdapter("SELECT * FROM HSHS WHERE year(NGAYSINH) = " + a + "", _conn);
                DataTable dtTimKiemHocSinh = new DataTable();
                da2.Fill(dtTimKiemHocSinh);
                da2.Dispose();
                return dtTimKiemHocSinh;
            ...
            {
                SqlDataAdapter da2 = new SqlDataAdapter("SELECT * FROM HSHS WHERE NGAYSINH = '" + tk.TenTimKiem + "'", _conn);
                DataTable dtTimKiemHocSinh = new DataTable();
                da2.Fill(dtTimKiemHocSinh);
                da2.Dispose();
                return dtTimKiemHocSinh;
            ...
            {
                SqlDataAdapter da2 = new SqlDataAdapter("SELECT * FROM HSHS WHERE " + tk.TenCot + " like '%" + tk.TenTimKiem + "%'", _conn);
                DataTable dtTimKiemHocSinh = new DataTable();
                da2.Fill(dtTimKiemHocSinh);
                da2.Dispose();
                return dtTimKiemHocSinh;
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("SELECT * FROM HSHS order by MAHS desc", _conn);
